...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
   ...
   assert.notDeepStrictEqual(productDetails('a')[0], productDetails('b')[1])
    // Teste que os dois productIds terminam com 123.
    assert.deepStrictEqual(productDetails('a','b')[0].details.productId, 'a123' );
    assert.deepStrictEqual(productDetails('a','b')[1].details.productId, 'b123' );
