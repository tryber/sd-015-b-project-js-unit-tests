...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(Object.values(productDetails())[0].details.productId.endsWith(123), true);
    assert.strictEqual(Object.values(productDetails())[1].details.productId.endsWith(123), true);
  });
});
