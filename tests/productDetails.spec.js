...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    const twoProducts = productDetails('Alcool gel', 'Máscara');
    assert.deepStrictEqual(twoProducts[0].details.productId.endsWith('123'), twoProducts[1].details.productId.endsWith('123'));
  });
});
