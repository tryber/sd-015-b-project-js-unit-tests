...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.ok(Object.keys(productDetails()).length === 2);
    ...
    assert.ok(productDetails()[0].details.productId.includes('123') === true)
    assert.ok(productDetails()[1].details.productId.includes('123') === true)
  });
});
