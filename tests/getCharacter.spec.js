...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    assert.strictEqual(typeof getCharacter, 'function');
    ...
    assert.deepStrictEqual(getCharacter('Arya'), output);
   ...
   assert.deepStrictEqual(getCharacter('Brienne'), output);
    ...
    assert.deepStrictEqual(getCharacter('Melissandre'), output);
    ...
    assert.deepStrictEqual(getCharacter('Raphael'), undefined);
  });
});
