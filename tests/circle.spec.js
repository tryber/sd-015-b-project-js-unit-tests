...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    // Utilizei o repositório do Vínicius Polo pra resolver o item seguinte - link: https://github.com/tryber/sd-014-a-project-js-unit-tests/pull/134/commits/7e300313fdcd07c2476139c69594bb7ffe7955f9
