...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  it('Verifica se a função `numbers`retorna `true` quando o array contém apenas numeros e falso caso contrário', () => {
    ...
    const fiveTrue = numbers([1, 2, 3, 4, 5]);
    assert.strictEqual(fiveTrue, true);
    // Escreva um teste em que a função recebe [1, 2, '3', 4, 5] e retorna false
    const fiveFalse = numbers([1, 2, '3', 4, 5]);
    assert.strictEqual(fiveFalse, false);
    // Escreva um teste em que a função recebe [1, 'a', 3] e retorna false
    const testFalse = numbers([1, 'a', 3]);
    assert.strictEqual(testFalse, false);
    // Escreva um teste em que a função recebe [' '] e retorna false
    const stringTrue = numbers([' ']);
    assert.strictEqual(stringTrue, false);
  });
});
