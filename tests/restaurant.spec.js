...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    // assert.fail();
    // TESTE 1: Verifique se o retorno da função createMenu() é um objeto que possui, mas não é necessariamente limitado à chave `fetchMenu`, a qual tem como valor uma função.
    ...
    // objetoRetornado.order = orderMenu;
    ...
    assert.deepStrictEqual(objetoRetornado.consumption, ["coxinha", "agua", "sopa", "cerveja"]);
    ...
    assert.deepStrictEqual(objetoRetornado.consumption, ["coxinha", "agua", "sopa", "cerveja", "coxinha"]);
