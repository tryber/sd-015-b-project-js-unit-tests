...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const thisIsObj = typeof createMenu() === 'object';
    const countKeys = Object.keys(createMenu()).length > 0;
    const firstKey = Object.keys(createMenu())[0] === 'fetchMenu';
    assert.strictEqual(thisIsObj && countKeys && firstKey, true);
    ...
    // ```
    const objPassado = { food: {}, drink: {} };
    const objetoRetornado = createMenu(objPassado);
    ...
    // ```
    assert.strictEqual(objetoRetornado.fetchMenu(), objPassado);
    ...
    // ```
    assert.deepStrictEqual(objetoRetornado1.consumption, ['coxinha', 'agua', 'coxinha']);
    ...
    // ```
    assert.deepStrictEqual(objetoRetornado1.pay(), 12.87);
