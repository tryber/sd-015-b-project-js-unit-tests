...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(`${typeof retorno} ${typeof retorno.fetchMenu}`, 'object function');
    ...
    const criaMenu = createMenu(menu);
     
     assert.strictEqual(criaMenu.fetchMenu(), menu);
    ...
    // ```
    const teste6 = createMenu(menu);
    teste6.order("coxinha");
    teste6.order("agua");
    teste6.order("sopa");
    teste6.order("sashimi");
    console.log(teste6);
    assert.deepStrictEqual(teste6.consumption, ["coxinha", "agua", "sopa", "sashimi"]); // Retorno: ["coxinha", "agua", "sopa", "sashimi"]
    // ```
    // Agora faça o TESTE 7 deste arquivo.
    // --------------------------------------------------------------------------------------
    // TESTE 7: Verifique que a função `order` aceita que pedidos repetidos sejam acrescidos a consumption.
    // ```
    const teste7 = createMenu(menu)
    ...
    teste8.order('agua');
    teste8.order('coxinha');
    teste8.pay() // Retorno: somaDosPreçosDosPedidos
    assert.strictEqual(parseFloat((teste8.pay()).toPrecision(4)), 12.87);
    // ```
