...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.deepStrictEqual(objetoRetornado3.fetchMenu(), {
      food: {},
      drink: {},
    ...
    assert.deepStrictEqual(objetoRetornado6.consumption, [
      'coxinha',
      'agua',
      'sopa',
      'sashimi',
    ...
    objetoRetornado7.order('coxinha');
    assert.deepStrictEqual(objetoRetornado7.consumption, [
      'coxinha',
      'agua',
      'coxinha',
    ...
    const objetoRetornado8 = createMenu(barzao);
    objetoRetornado8.order('coxinha');
    objetoRetornado8.order('agua');
    objetoRetornado8.order('coxinha');
    assert.deepStrictEqual(objetoRetornado8.pay(), 12.87); // Retorno: somaDosPreçosDosPedidos
    // ```
