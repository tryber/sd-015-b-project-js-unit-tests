...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(typeof createMenu(menu), 'object');
    assert.strictEqual(Object.keys(createMenu(menu)).includes('fetchMenu'), true);
    ...
    assert.strictEqual(typeof objetoRetornado.fetchMenu(), 'object');
    ...
    // ```
    const buteco = createMenu(menu);
    buteco.order('coxinha');
    assert.deepStrictEqual(buteco.consumption, ['coxinha']);
    ...
    buteco.order('agua');
    buteco.order('sopa');
    buteco.order('sashimi');
    assert.deepStrictEqual(buteco.consumption, ["coxinha", "agua", "sopa", "sashimi"]);
    ...
    buteco.consumption.pop();
    buteco.consumption.pop();
    buteco.order('coxinha');
    assert.deepStrictEqual(buteco.consumption, ['coxinha', 'agua', 'coxinha']);
    ...
    assert.strictEqual(buteco.pay(), 12.87);
    // ```
