...
// ******* feito em pair programing com os colegas Leonando, Gabriel Alves, Caio, Camila ********
/*
...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.ok(Object.keys(meuRestaurante).includes('fetchMenu'));
    ...
    assert.deepStrictEqual(menu, meuRestaurante.fetchMenu());
    // ```
  ...
  // TESTE 4: Verifique que 'objetoRetornado.consumption', após a criação do menu, retorna um array vazio.
    ...
    // ```
    meuRestaurante.consumption.pop();
    meuRestaurante.consumption.pop();
    meuRestaurante.order('coxinha');
