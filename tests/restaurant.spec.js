...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const objetoQualquer = createMenu(obj);
    assert.deepStrictEqual(obj, objetoQualquer.fetchMenu());
    ...
    // ```
    const objetoRetornado4 = createMenu(obj);
    ...
    // ```
    const objetoRetornado8 = createMenu(obj)
